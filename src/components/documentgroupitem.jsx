                ...
                {groups.map((group, index) => (
                    <div key={index} style={{ marginBottom: '100px' }}>
                        <div style={{ 
                            ...
                            <img src="/docTaiLieu.png" alt="icon" style={{ width: '24px', height: '24px', marginRight: '10px' }} />
                            <span style={{ color: "#333", fontWeight: "bold", fontSize: "16px", textTransform: 'uppercase' }}>
                                {group.GROUP_NAME}
                            </span>
                        </div>
                        ...
                        {group.documents && group.documents.length > 0 ? (
                                        ...
                                        <div key={idx} style={{ padding: '10px' }}>
                                            ...
                                            >
                                                ...
                                                <div style={{ 
                                                    ...
                                                    {getActions(item).map((action, actionIdx) => (
                                                        <React.Fragment key={actionIdx}>{action}</React.Fragment>
                                                    ))}
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div style={{ padding: '0 25px', textAlign: 'center', color: '#999' }}>Không có tài liệu</div>
                        )}
                    </div>
                ))}
            </div>
