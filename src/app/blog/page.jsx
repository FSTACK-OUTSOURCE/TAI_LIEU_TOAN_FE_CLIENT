        ...
        <section className="mt-2">
            ...
            {blogs.length === 0 ? (
                <div className="blogEmpty">
                    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2" style={{ marginBottom: 12, display: 'block', margin: '0 auto 12px' }}>
                        ...
                        <div className="col-sm-6 col-lg-4" key={blog.BLOG_ID}>
                            <Link href={`/blog/${blog.TITLE_SLUG}`} className="blogCard">
                                ...
                                <div className="blogCardBody">
                                    ...
                                    {blog.DESCRIPTION && (
                                        <p className="blogCardDesc">{blog.DESCRIPTION}</p>
                                    )}
